...
- 用户端社区活动分为“我的活动”和“可选择的活动”，支持查看活动详情、报名状态和报名时间。
...
3. 在用户列表切换卡片/列表，测试搜索、新增、编辑、标签、详情和删除；进入用户详情，逐个检查资料、用药、健康数据、设备、报告、订单、优惠券、积分、内容和服务记录。
4. 在其余管理列表测试筛选、横向滑动表格、详情、新增、编辑、删除、分页；轮播图、头像和报告分别测试图片或文件上传。
