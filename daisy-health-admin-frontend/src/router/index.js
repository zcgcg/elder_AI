...
const routes = [
  ...
  { path: '/portal/service', component: ServicePortalView },
  {
    ...
    children: [
      ...
      { path: 'service/work-orders', component: GenericListView, meta: { title: '履约工单', resource: 'workOrders' } },
      { path: 'products/:category?', component: GenericListView, meta: { title: '商品服务管理', resource: 'products' } },
      { path: 'product-ext/:resource', redirect: '/products' },
      { path: 'operations/:resource', component: GenericListView, meta: { title: '运营管理', resourceFromParam: true } },
      { path: 'trade/orders', component: GenericListView, meta: { title: '交易订单', resource: 'orders' } },
