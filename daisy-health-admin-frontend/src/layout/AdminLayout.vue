...
const menuGroups = [
  ...
  { key: 'service', label: '服务', icon: 'Service', children: [{ label: '服务人员', path: '/service/personnel' }, { label: '审核管理', path: '/service/audits' }, { label: '履约工单', path: '/service/work-orders' }] },
  ...
  { key: 'trade', label: '交易', icon: 'Wallet', children: [{ label: '交易订单', path: '/trade/orders' }, { label: '售后管理', path: '/trade/after-sales' }, { label: '评价管理', path: '/trade/reviews' }] },
